...
export default function WhatsAppButton() {
    ...
    return (
        <Link
            ...
            className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20ba5a] text-white p-3.5 rounded-full shadow-xl transition-all hover:scale-110 flex items-center justify-center animate-bounce-subtle group"
